...
//
//  > cat ./samples/csv/csv-import/perf_test.go
//  type perfSuite {
//    suite.PerfSuite
//  }
//
...
//
//  > noms serve &
//  > go test -v ./samples/csv/... -perf http://localhost:8000 -perf.repeat 3
...
import (
	...
	"github.com/attic-labs/noms/nbs"
...
type PerfSuite struct {
	...
	// AtticLabs is the path to the attic-labs directory (e.g. /path/to/src/github.com/attic-labs).
	AtticLabs string

	// Testdata is the path to the testdata directory - typically /path/to/src/github.com/attic-labs, but it can be overridden with the -perf.testdata flag.
	Testdata string
