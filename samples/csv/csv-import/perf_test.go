...
import (
	...
	"github.com/attic-labs/noms/perf/suite"
	"github.com/attic-labs/noms/types"
	"github.com/attic-labs/noms/samples/csv"
...
func (s *perfSuite) SetupSuite() {
	...
	err := exec.Command("go", "build", "-o", s.csvImportExe, "github.com/attic-labs/noms/samples/csv/csv-import").Run()
