...
func makeTestDb(s *testSuite, dsId string) datas.Database {
    ...
    fmt.Println("ldbDir:", s.LdbDir)
    l1 := []TestObj{
        TestObj{1, "will", "smith", "m", 40},
        TestObj{2, "lana", "turner", "f", 91},
        TestObj{3, "john", "wayne", "m", 86},
        TestObj{4, "johnny", "depp", "m", 50},
        TestObj{5, "merrill", "streep", "f", 60},
        TestObj{6, "rob", "courdry", "m", 45},
        TestObj{7, "bruce", "lee", "m", 72},
        TestObj{8, "bruce", "willis", "m", 36},
        TestObj{9, "luis", "bunuel", "m", 100},
        TestObj{10, "andy", "sandberg", "m", 32},
        TestObj{11, "walter", "coggins", "m", 28},
        TestObj{12, "seth", "rogan", "m", 29},
    }
    
    m1 := map[string]TestObj {
        "lg": TestObj{13, "lady", "gaga", "f", 39},
        "ss": TestObj{14, "sam", "smith", "m", 28},
        "rp": TestObj{15, "robert", "plant", "m", 69},
        "ml": TestObj{16, "meat", "loaf", "m", 65},
        "gf": TestObj{17, "glenn", "frey", "m", 60},
        "jr": TestObj{18, "joey", "ramone", "m", 55},
        "rc": TestObj{19, "ray", "charles", "m", 72},
        "bk": TestObj{20, "bb", "king", "m", 77},
        "b": TestObj{21, "beck", "", "m", 38},
        "md": TestObj{22, "miles", "davis", "m", 82},
        "rd": TestObj{23, "roger", "daltry", "m", 62},
        "jf": TestObj{24, "john", "fogerty", "m", 60},
    }
