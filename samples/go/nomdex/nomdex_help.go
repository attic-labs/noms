...
var usageTemplate = `Nomdex builds indexes to support fast queries.

Usage:

	nomdex command [arguments]

The commands are:
{{range .Commands}}
	{{.Name | printf "%-11s"}} {{.Short}}{{end}}

Use "nomdex help [command]" for more information about a command.
