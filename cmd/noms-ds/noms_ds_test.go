...
func (s *testSuite) TestNomsDs() {
	...
	s.Equal("Deleted dataset "+id+" (was 4ozv8ollylrhfv4lbcc4865km4s8zxnpsl1eqvfwdxzesegvc3)\n\n", rtnVal)
	...
	s.Equal("Deleted dataset "+id2+" (was 0p3re1cxpsbfr6qlxzulusfjbatai6qanco17y5qnrllnfntea)\n\n", rtnVal)
