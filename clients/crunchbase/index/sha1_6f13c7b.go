...
var __mainPackageInFile_sha1_6f13c7b_CachedRef ref.Ref
...
func init() {
	...
	__mainPackageInFile_sha1_6f13c7b_CachedRef = types.RegisterPackage(&p)
}
...
func init() {
	__typeForImport = types.MakeType(__mainPackageInFile_sha1_6f13c7b_CachedRef, 0)
...
func init() {
	__typeForInputs = types.MakeType(__mainPackageInFile_sha1_6f13c7b_CachedRef, 1)
...
func init() {
	__typeForDate = types.MakeType(__mainPackageInFile_sha1_6f13c7b_CachedRef, 2)
