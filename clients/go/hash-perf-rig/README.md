This is a performance test rig for the two main types of hashing we do in NOMS - buzhash and sha1. There's also support for sha256 and sha512 for comparison.
