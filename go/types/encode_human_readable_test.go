...
func TestWriteHumanReadableBlob(t *testing.T) {
	assertWriteHRSEqual(t, "/* 0 B */", NewEmptyBlob())
	assertWriteTaggedHRSEqual(t, "Blob(/* 0 B */)", NewEmptyBlob())

	b1 := NewBlob(bytes.NewBuffer([]byte{0x01}))
	assertWriteHRSEqual(t, "/* 1 B */01", b1)
	assertWriteTaggedHRSEqual(t, "Blob(/* 1 B */01)", b1)

	b2 := NewBlob(bytes.NewBuffer([]byte{0x01, 0x02}))
	assertWriteHRSEqual(t, "/* 2 B */01 02", b2)
	assertWriteTaggedHRSEqual(t, "Blob(/* 2 B */01 02)", b2)

	b3 := NewBlob(bytes.NewBuffer([]byte{
		0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
		0x08, 0x09, 0x0a, 0x0b, 0x0c, 0x0d, 0x0e, 0x0f,
	}))
	assertWriteHRSEqual(t, "/* 16 B */00 01 02 03 04 05 06 07 08 09 0a 0b 0c 0d 0e 0f", b3)
	assertWriteTaggedHRSEqual(t, "Blob(/* 16 B */00 01 02 03 04 05 06 07 08 09 0a 0b 0c 0d 0e 0f)", b3)
	...
	assertWriteHRSEqual(t, "/* 17 B */00 01 02 03 04 05 06 07 08 09 0a 0b 0c 0d 0e 0f\n10", b4)
	assertWriteTaggedHRSEqual(t, "Blob(/* 17 B */00 01 02 03 04 05 06 07 08 09 0a 0b 0c 0d 0e 0f\n10)", b4)
...
func TestWriteHumanReadableListOfBlob(t *testing.T) {
	...
	assertWriteHRSEqual(t, "[ // 4 items\n  /* 1 B */01,\n  /* 0 B */,\n  /* 1 B */02,\n  /* 17 B */00 01 02 03 04 05 06 07 08 09 0a 0b 0c 0d 0e 0f\n  10,\n]", l)
