...
suite('MapLeaf', () => {
  ...
  test('first/get', async () => {
    ...
    assert.strictEqual(null, await m.get('b'));
    assert.strictEqual(8, await m.get('k'));
    assert.strictEqual(null, await m.get('z'));
  });
...
suite('CompoundMap', () => {
  ...
  test('get', async () => {
    ...
    assert.strictEqual(null, await c.get('c'));
    assert.strictEqual(null, await c.get('d'));
    ...
    assert.strictEqual(null, await c.get('j'));
    assert.strictEqual(null, await c.get('k'));
    assert.strictEqual(null, await c.get('l'));
    assert.strictEqual(true, await c.get('m'));
    assert.strictEqual(false, await c.get('n'));
    assert.strictEqual(null, await c.get('o'));
  });
